# A simple example how to connect with the Wikitude Cloud Targets API using Ruby.
# This example is published under Apache License, Version 2.0
# http://www.apache.org/licenses/LICENSE-2.0.html
# @author Wikitude
require_relative "../src/TargetsAPI"
...
# create the object
api = TargetsAPI.new(API_TOKEN, API_VERSION)
# run the sample and print the wtc file URL to the console
puts api.convert(EXAMPLE_IMAGE_URLS)
